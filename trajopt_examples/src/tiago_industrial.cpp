...
int main(int argc, char *argv[])
{
    ...
    const std::string filename = "/tmp/industrial_trajopt_arm_torso.csv";
    ...
    std::vector<std::array<double, 3> > dims = { { 0.4, 1.4, 0.02 },   { 0.3, 0.02, 0.45 },  { 0.3, 0.02, 0.45 },
                                                 { 0.3, 0.52, 0.02 },  { 1.1, 0.3, 0.02 },   { 0.02, 0.2, 0.3 },
                                                 { 0.02, 0.2, 0.3 },   { 0.02, 0.2, 0.3 },   { 0.42, 0.3, 0.02 },
                                                 { 0.02, 0.1, 0.06 },  { 0.02, 0.1, 0.06 },  { 0.02, 0.1, 0.06 },
                                                 { 0.42, 0.02, 0.06 }, { 0.42, 0.02, 0.06 }, { 0.42, 0.02, 0.34 },
                                                 { 0.42, 0.02, 0.02 } };
    std::vector<std::array<double, 3> > positions = { { 0.75, -0.1, 0.7 },  { 0.8, 0.25, 0.925 }, { 0.8, -0.25, 0.925 },
                                                      { 0.8, 0.0, 1.16 },   { 0.4, -0.65, 0.7 },  { 0.1, -0.7, 0.85 },
                                                      { 0.3, -0.7, 0.85 },  { 0.5, -0.7, 0.85 },  { 0.3, -0.65, 0.71 },
                                                      { 0.1, -0.55, 0.73 }, { 0.3, -0.55, 0.73 }, { 0.5, -0.55, 0.73 },
                                                      { 0.3, -0.5, 0.73 },  { 0.3, -0.59, 0.93 }, { 0.3, -0.79, 0.87 },
                                                      { 0.3, -0.7, 0.9 } };
    ...
    {
        std::shared_ptr<shapes::Shape> collision_object(
            new shapes::Box(dim_iter->at(0), dim_iter->at(1), dim_iter->at(2)));
